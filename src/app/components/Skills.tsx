  ...
  return (
    <div className='min-h-screen bg-neutral-900 justify-center items-center py-8'>
      <div className='space-y-8'>
        ...
        <div data-aos="fade-in" className='bg-neutral-950 flex justify-center items-center shadow-white rounded-2xl'>
          <div className='py-6 px-6  space-y-2 hover:scale-x-110 duration-300'>
            <Image src="css.webp" alt="" width={100} height={100}/>
        ...
        <div data-aos="fade-in" className='bg-neutral-950 flex justify-center items-center shadow-white rounded-2xl'>
          <div className='py-6 px-6  space-y-2 hover:scale-x-110 duration-300'>
            <Image src="nodejs.png" alt="" width={100} height={100} className='bg-transparent'/>
        ...
        <div data-aos="fade-in" className='bg-neutral-950 flex justify-center items-center shadow-white rounded-2xl'>
          <div className='py-6 px-6  space-y-2 hover:scale-x-110 duration-300'>
            <Image src="github.png" alt="" width={100} height={100} className='bg-transparent'/>
        ...
        <div data-aos="fade-in" className='bg-neutral-950 flex justify-center items-center shadow-white rounded-2xl'>
          <div className='py-6 px-6  space-y-2 hover:scale-x-110 duration-300'>
            <Image src="react.png" alt="" width={100} height={100} className='bg-transparent'/>
        ...
        <div data-aos="fade-in" className='bg-neutral-950 flex justify-center items-center shadow-white rounded-2xl'>
          <div className='py-6 px-6  space-y-2 hover:scale-x-110 duration-300'>
            <Image src="nextjs.png" alt="" width={100} height={100} className=' text-white'/>
